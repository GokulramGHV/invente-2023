  ...
  rounds: [
    {
      ...
      description: `1.Healthcare technologies.  
        2.Fintech.  
    ...
    {
      name: 'First review',
      description: `1.Teams are expected to explain their problem statement, background study done and the workflow of their solution.   
    ...
    {
      name: 'Second review',
      description: `1.This review is a checkpoint to track the team’s progress.  
        2. The reviewers will give their input and their thoughts on the team’s solution and changes if there any are warranted.`,
    },
    {
      name: 'Third review',
      description: `1.Teams are expected to implement the changes given in the previous review by the reviewers.  
    ...
    },
    {
      ...
      description: `1.In this round, teams will be evaluated based on presentation skills, ability to explain their idea in a lucid manner and the degree of innovation in their solution.  
        2. Teams which address the marketability of their product will be awarded additional points. The hackathon will follow a leader board system. The final score will be the cumulative points gained by the team over the three reviews and final presentation. The team with the highest score will be announced the winner of the hackathon. Decisions taken by the review panel will be final in all regards.`,
    },
  ],
