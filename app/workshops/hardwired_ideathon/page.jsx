...
export default function HACKFINITY() {
    ...
    return (
        <>
            ...
            <div
                className="flex flex-col justify-center items-center min-h-screen bg-full w-full z-10  sm:px-12 px-6 pt-16 pb-14 bg-gradient-to-b from-[#00000066] to-transparent"
                style={{
