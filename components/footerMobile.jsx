...
export default function FooterMobile() {
  ...
  return (
    <div className="flex flex-col justify-center items-center gap-6 bg-gradient-to-r from-[#1D1F2A] from-100% to-[#1D1F2AE5] to-90% overflow-hidden w-full pt-10">
      <Image src="/invente.png" alt="invente" width={186} height={70} />
      ...
      <div className="flex items-center gap-8">
        <a href="https://www.snuchennai.edu.in/" target="_blank">
          <Image src="/snuLogo.svg" alt="SNU Logo" height={35} width={110} />
        </a>
        <a href="http://www.ssn.edu.in/" target="_blank">
          <Image src="/ssnLogo.svg" alt="SSN Logo" height={35} width={80} />
        </a>
      </div>
      <div className="box-border h-0 w-[190px] border-[1px] border-[#FFFFFF2B]"></div>
      ...
      <div className="bg-[#303746] text-white w-full text-center items-center text-[14px] p-[10px] leading-6">
        ...
        {', '}
        <span className="underline">
          <a href="https://www.linkedin.com/in/vaishnavejp/"> Vaishnave JP</a>
        </span>
        {', '}
